 ...
 */
class CompilerFile extends \Zephir\CompilerFileAbstract
{
    /**
     * Compiles a function
     *
    ...
    public function preCompile(Compiler $compiler)
    {
         ...
         * Alias Manager
         */
        $this->_aliasManager = new \Zephir\AliasManager();
     ...
     */
    public function compile(CompilerAbstract $compiler, StringsManager $stringsManager)
    {
        if (!$this->_ir) {
