...
PHP_METHOD(Test_Oo, testInstance2) {
	...
	ZEPHIR_CALL_METHOD(NULL, o, "__construct", NULL, 79);
...
PHP_METHOD(Test_Oo, testInstance4) {
	...
	ZEPHIR_CALL_METHOD(NULL, o, "__construct", NULL, 80, a, b);
	zephir_check_call_status();
	RETURN_CCTOR(o);
...
PHP_METHOD(Test_Oo, testInstance5) {
	...
	ZEPHIR_CALL_METHOD(NULL, o, "__construct", NULL, 80, _0, _1);
...
PHP_METHOD(Test_Oo, testInstance9) {
	...
	ZEPHIR_CALL_CE_STATIC(&o, test_oo_oodynamica_ce, "getnew", &_0, 81);
	zephir_check_call_status();
	RETURN_CCTOR(o);
...
PHP_METHOD(Test_Oo, testInstance10) {
	...
	ZEPHIR_CALL_CE_STATIC(&o, test_oo_oodynamicb_ce, "getnew", &_0, 81);
	zephir_check_call_status();
	RETURN_CCTOR(o);
